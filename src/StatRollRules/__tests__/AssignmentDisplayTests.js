...
describe('AssignmentDisplay tests', () => {
    ...
    describe('AssignmentControl components', () => {
        ...
        beforeEach(() => {
            ...
            component = mount(<AssignmentDisplay rolls={testRolls} selectedChar={{}}/>);
        ...
        const getTestRolls = () => {
            return [{id: 1, value: 3, assigned: false}];
        };
    });
    ...
    describe('Assign button', () => {
        ...
        describe('Assigns stats and clears selected stat and roll', () => {
            ...
            it('invalid stat', () => {
                ...
                const component = shallow(<AssignmentDisplay selectedChar={{}} rolls={testRolls}/>);
    ...
    describe('Reset button', () => {
        ...
        it('resets all stats to undefined and all rolls to unassigned when clicked', () => {
            const component = shallow(<AssignmentDisplay
