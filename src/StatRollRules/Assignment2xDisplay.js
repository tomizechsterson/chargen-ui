...
export default class Assignment2xDisplay extends Component {
  ...
  resetAssignments() {
    const { selectedChar, rolls } = this.props;
    selectedChar.str = undefined;
    rolls[0].assigned = false;
    rolls[1].assigned = false;
    selectedChar.dex = undefined;
    rolls[2].assigned = false;
    rolls[3].assigned = false;
    selectedChar.con = undefined;
    rolls[4].assigned = false;
    rolls[5].assigned = false;
    selectedChar.int = undefined;
    rolls[6].assigned = false;
    rolls[7].assigned = false;
    selectedChar.wis = undefined;
    rolls[8].assigned = false;
    rolls[9].assigned = false;
    selectedChar.chr = undefined;
    rolls[10].assigned = false;
    rolls[11].assigned = false;
    this.setState({ selectedStat: '', selectedRoll: undefined });
  }
    ...
    return (
      <div data-cy='statAssignment2xDiv'>
        ...
        <AssignmentControl
          ...
          rolls={ [strRoll1, strRoll2] }
        />
        <AssignmentControl
          onSelectStat={ this.handleSelectStat }
          onSelectRoll={ this.handleSelectRoll }
          stat={ 'DEX' }
          charStat={ selectedChar.dex }
          rolls={ [dexRoll1, dexRoll2] }
        />
        <AssignmentControl
          onSelectStat={ this.handleSelectStat }
          onSelectRoll={ this.handleSelectRoll }
          stat={ 'CON' }
          charStat={ selectedChar.con }
          rolls={ [conRoll1, conRoll2] }
        />
        <AssignmentControl
          onSelectStat={ this.handleSelectStat }
          onSelectRoll={ this.handleSelectRoll }
          stat={ 'INT' }
          charStat={ selectedChar.int }
          rolls={ [intRoll1, intRoll2] }
        />
        <AssignmentControl
          onSelectStat={ this.handleSelectStat }
          onSelectRoll={ this.handleSelectRoll }
          stat={ 'WIS' }
          charStat={ selectedChar.wis }
          rolls={ [wisRoll1, wisRoll2] }
        />
        <AssignmentControl
          onSelectStat={ this.handleSelectStat }
          onSelectRoll={ this.handleSelectRoll }
          stat={ 'CHR' }
          charStat={ selectedChar.chr }
          rolls={ [chrRoll1, chrRoll2] }
        />
        ...
        <input
          ...
          value='Assign'
          disabled={ this.disableAssignButton() }
        />
        <input
          type='button'
